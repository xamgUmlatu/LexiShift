(() => {
  ...
  function buildPreflightBlockedLines(options) {
    ...
    return [
      ...
      `- translation_dict_path: ${helperData.translation_dict_path || helperData.freedict_de_en_path || "n/a"} (exists=${helperData.translation_dict_exists === true})`,
  ...
  function buildRuntimeDiagnosticsOutput(options) {
    ...
    return [
      ...
      helperData ? `- translation_dict_path: ${helperData.translation_dict_path || helperData.freedict_de_en_path || "n/a"} (exists=${helperData.translation_dict_exists === true})` : null,
  ...
  function buildSampledRulegenEmptyOutput(options) {
    ...
    const diagLines = [
      ...
      `- translation_dict: ${diag.translation_dict_path || diag.freedict_de_en_path || "n/a"} (exists=${diag.translation_dict_exists ?? diag.freedict_de_en_exists})`,
