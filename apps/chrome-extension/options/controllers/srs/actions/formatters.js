(() => {
  ...
  const admissionPreviewFormatter = root.optionsSrsAdmissionPreviewFormatter && typeof root.optionsSrsAdmissionPreviewFormatter.buildAdmissionPreviewOutput === "function"
    ? root.optionsSrsAdmissionPreviewFormatter.buildAdmissionPreviewOutput : null;
  const sampledRulegenFormatter = root.optionsSrsSampledRulegenFormatter && typeof root.optionsSrsSampledRulegenFormatter === "object"
    ? root.optionsSrsSampledRulegenFormatter : null;
  ...
  function buildSampledRulegenSamplingLines(options) {
    return sampledRulegenFormatter
      && typeof sampledRulegenFormatter.buildSampledRulegenSamplingLines === "function"
      ? sampledRulegenFormatter.buildSampledRulegenSamplingLines(options)
      : [];
  }

  function buildSampledRulegenHeader(options) {
    return sampledRulegenFormatter
      && typeof sampledRulegenFormatter.buildSampledRulegenHeader === "function"
      ? sampledRulegenFormatter.buildSampledRulegenHeader(options)
      : "";
  }

  function buildSampledRulegenEmptyOutput(options) {
    return sampledRulegenFormatter
      && typeof sampledRulegenFormatter.buildSampledRulegenEmptyOutput === "function"
      ? sampledRulegenFormatter.buildSampledRulegenEmptyOutput(options)
      : "";
  }

  function buildSampledRulegenTargetsOutput(options) {
    return sampledRulegenFormatter
      && typeof sampledRulegenFormatter.buildSampledRulegenTargetsOutput === "function"
      ? sampledRulegenFormatter.buildSampledRulegenTargetsOutput(options)
      : "";
  }
