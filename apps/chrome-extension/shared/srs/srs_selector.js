(() => {
  ...
  async function loadDataset() {
    ...
    const url = root.chrome && root.chrome.runtime
      ? root.chrome.runtime.getURL("shared/srs/srs_selector_test_dataset.json")
      : (globalThis.chrome && chrome.runtime ? chrome.runtime.getURL("shared/srs/srs_selector_test_dataset.json") : "");
    if (!url) {
