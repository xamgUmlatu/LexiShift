...
_SOURCE_STACKS: dict[str, PairSourceStack] = {
    "en-ja": PairSourceStack(
        ...
        resources=(
            ...
            SourceStackResource(
                role="learner_kanji_signals",
                family="language",
                pack_id="kanjidic2-ja",
                label_key="language_packs.learning_pairs.resources.kanjidic2_ja",
                optional_for=("learner_difficulty", "srs_admission"),
                pair_setup=True,
                joins_on="target_kanji",
                notes=("optional_enrichment_missing_does_not_block_bootstrap",),
            ),
            SourceStackResource(
                role="proper_name_signals",
                family="language",
                pack_id="jmnedict-ja",
                label_key="language_packs.learning_pairs.resources.jmnedict_ja",
                optional_for=("proper_name_detection", "srs_admission"),
                pair_setup=True,
                joins_on="target_headword",
                notes=("optional_enrichment_missing_does_not_block_bootstrap",),
            ),
            SourceStackResource(
                role="visual_component_signals",
                family="language",
                pack_id="kanjivg-ja",
                label_key="language_packs.learning_pairs.resources.kanjivg_ja",
                optional_for=("visual_complexity", "compositionality_research", "srs_admission"),
                pair_setup=True,
                joins_on="target_kanji",
                notes=("optional_enrichment_missing_does_not_block_bootstrap",),
            ),
            SourceStackResource(
                role="target_jlpt_vocabulary_signals",
                family="language",
                pack_id="jlpt-tanos-vocab-ja",
                label_key="language_packs.learning_pairs.resources.jlpt_tanos_vocab_ja",
                optional_for=("learner_difficulty", "srs_admission"),
                pair_setup=True,
                joins_on="target_headword",
                notes=("optional_enrichment_missing_does_not_block_bootstrap",),
            ...
            SourceStackResource(
                role="target_beginner_lesson_order_signals",
                family="language",
                pack_id="sbsjapanese1-ja",
                label_key="language_packs.learning_pairs.resources.sbsjapanese1_ja",
                optional_for=("learner_difficulty", "srs_admission"),
                pair_setup=True,
                joins_on="target_headword",
                notes=("optional_enrichment_missing_does_not_block_bootstrap",),
