...
DEFAULT_PACK_ID = "en-es-active-only-combined-full-v1-tranche-011"
...
_DEV_PACK_INVENTORY_BY_PAIR_AND_ID = {
    ...
    (
        ...
        "docs/test_outputs/experiments/semantic_veto_source_packaging/"
        "en-es-active-only-combined-full-v1-tranche-010_semantic_inventory.json"
    ),
    (
        "en-es",
        ...
        "docs/test_outputs/experiments/semantic_veto_source_packaging/"
        "en-es-active-only-combined-full-v1-tranche-009_semantic_inventory.json"
    ),
    (
        "en-es",
        ...
        "docs/test_outputs/experiments/semantic_veto_source_packaging/"
        "en-es-active-only-combined-full-v1-tranche-008_semantic_inventory.json"
    ),
    (
        "en-es",
        ...
        "docs/test_outputs/experiments/semantic_veto_source_packaging/"
        "en-es-active-only-combined-full-v1-tranche-007_semantic_inventory.json"
    ),
    (
        "en-es",
        ...
        "docs/test_outputs/experiments/semantic_veto_source_packaging/"
        "en-es-active-only-combined-full-v1-tranche-006_semantic_inventory.json"
    ),
    (
        "en-es",
        ...
        "docs/test_outputs/experiments/semantic_veto_source_packaging/"
        "en-es-active-only-combined-full-v1-tranche-005_semantic_inventory.json"
    ),
    (
        "en-es",
