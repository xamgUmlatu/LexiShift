...
DEFAULT_MARKDOWN_OUT = (
    TEST_OUTPUTS_ROOT / "srs_wikidata_science_topic_overlay_en_es_spalex_10k_latest.md"
)
LANGUAGE_PAIR = "en-es"
OVERLAY_ID = "srs_wikidata_science_topic_overlay_en_es_spalex_10k_v1"
...
ELEMENT_EXCLUDED_LEMMAS = {
    # Dominant Spanish senses are not chemical elements in learner-topic contexts.
    "indio",
    "radio",
}
UNIT_EXACT_LABELS = {
...
UNIT_EXCLUDED_LEMMAS = {
    # `metro` is too often subway/metro system in product topic contexts.
    "metro",
}
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build a conservative en-es science topic overlay from bounded Wikidata "
    ...
    *,
    ...
    return {
        ...
        "overlay_policy": {
            ...
            "topic_policy": (
                "chemical elements and unit-shaped measurement labels are routed to "
                "science_technology; noisy homographs are excluded."
            ),
            "match_policy": "lowercase_exact_wikidata_spanish_label_in_spalex_top_n",
        },
        "inputs": {
        ...
        "limitations": [
            ...
            "Units are limited to local unit-shaped labels before Wikidata verification to avoid currency and homograph noise.",
            "Rows are exact Spanish label matches; aliases are not promoted for this safe pass.",
        ],
    }
...
def render_markdown(report: Mapping[str, object]) -> str:
    ...
    lines = [
        "# en-es Wikidata Science Topic Overlay",
        "",
    ...
    *,
    ...
    return {
        ...
        "provenance": {
            ...
            "source_license": "Wikidata structured data CC0",
            "runtime_dependency": "none",
            "match_policy": "exact_spanish_label_in_spalex_top_n",
        },
    }
...
def _review_id(source_id: str, lemma: str, topic: str) -> str:
    ...
    return f"srs-enes-wikidata-science-{digest}"
