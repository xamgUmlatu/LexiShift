    ...
    for combo in itertools.product(
        ...
        configs.append(
            SweepConfig(
                ...
                include_variants=bool(combo[9]),
                pos_scoring_enabled=bool(combo[10]),
                pos_exact_match_bonus=float(combo[11]),
                pos_compatible_match_bonus=float(combo[12]),
                score_weight_dict_priority=float(combo[13]),
                score_weight_frequency_weight=float(combo[14]),
                score_weight_pos_match=float(combo[15]),
                score_weight_variant_penalty=float(combo[16]),
                score_weight_phrase_penalty=float(combo[17]),
                score_weight_embedding=float(combo[18]),
                reverse_check_enabled=bool(combo[19]),
                reverse_check_match_bonus=float(combo[20]),
                reverse_check_near_bonus=float(combo[21]),
                reverse_check_near_rank_max=max(0, int(combo[22])),
                reverse_check_far_hit_penalty=float(combo[23]),
