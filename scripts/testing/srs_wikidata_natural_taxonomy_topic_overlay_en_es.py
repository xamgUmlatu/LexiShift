...
DEFAULT_CANDIDATES_JSON = (
    TEST_OUTPUTS_ROOT / "srs_wikidata_natural_taxonomy_candidates_en_es_latest.json"
)
DEFAULT_JSON_OUT = (
    TEST_OUTPUTS_ROOT / "srs_wikidata_natural_taxonomy_topic_overlay_en_es_spalex_10k_latest.json"
)
DEFAULT_MARKDOWN_OUT = (
    TEST_OUTPUTS_ROOT / "srs_wikidata_natural_taxonomy_topic_overlay_en_es_spalex_10k_latest.md"
)
DEFAULT_PAIR = "en-es"
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "en-es SRS topic overlay artifact. This consumes local candidate artifacts only; "
...
def build_overlay(
    *,
    ...
    return {
        ...
        "overlay_id": "srs_wikidata_natural_taxonomy_topic_overlay_en_es_spalex_10k_v1",
        ...
        "overlay_policy": {
            ...
            "source": "Wikidata structured data label/alias intersection promoted from local candidate packet",
