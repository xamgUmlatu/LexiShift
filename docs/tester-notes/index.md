...
3. Download `LexiShift-0.1.0.dmg`.
...
Use the app for a short first pass. A useful test can be as simple as:

1. Launch LexiShift.
2. Look around the first screen and setup flow.
3. Try creating or opening a profile.
4. Try the obvious next action the app seems to suggest.
...
- whether you were able to get to a point where the app felt usable.
...
- The Chrome extension path is separate from this desktop app download.
