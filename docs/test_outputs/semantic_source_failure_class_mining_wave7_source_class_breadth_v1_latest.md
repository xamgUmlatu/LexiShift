...
- Generated: `2026-04-30T18:07:59Z`
...
- Admission final rows: `134`
- Seed ablation harmful / false abstain: `0` / `0`
- Held-out: `semantic_source_non_v10_wave7_source_class_breadth_v1_heldout_validation_latest`
- Held-out cases: `32` across `16` families
- Held-out harmful / false abstain: `1` / `5`
...
| `heldout_false_abstain` | `5` | `False` | `True` | `even, fix, full, like, meet` |
| `additional_heldout_1_harmful_replace` | `6` | `True` | `False` | `cast, foul, score, squeeze, stretch, wrong` |
| `primary_sense_reject` | `42` | `False` | `True` | `competitor_sense_not_lower` |
...
- Source rows: `75`
- Source families: `16`
- Held-out cases per admitted row: `0.3582`
...
- Source-mode sense-reject delta: `38`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `semantic_source_non_v10_wave7_source_class_breadth_v1_phrase_validation_latest` | `non_v10_wave7_source_class_breadth_phrase_no_winner` | `16` | `16` | `6` | `0` | `0.6250` |
...
| `semantic_source_class_frame_evidence_wave7_source_class_breadth_v1_latest` | `source_class_frame_rows_ready` | `0` | `75` | `0` | `0` |
