...
- Status: `ok`
- Generated: `2026-04-11T03:04:13Z`
...
### Candidate
- Experiment: `promotion_semantic_bridge_aux_text_examples_on`
- Label: `Borrowed baseline with semantic-bridge aux text and examples on`
- Seed mode / policy: `rulegen_top3_plus_forward_gloss_plus_neighbor_borrow` / `support_score_v1`
- Trigger filter min: `0.0`
- Shadow support min / max promoted: `5.0` / `2`
- Semantic-bridge aux text / examples: `True` / `True`
- Gold precision / recall / F1: `75.9%` / `44.0%` / `55.7%`
- Veto accuracy / abstain recall / harmful allow / overblocking: `89.1%` / `54.5%` / `45.5%` / `2.8%`
- Veto counts: `false_abstain=4`, `harmful_allow=15`

## Deltas
- Gold precision delta: `-2.7%`
...
| feature:feature_semantic_bridge_candidate_count:none | 21 | 13 | 13 | 61.9% | 16.5% | seed=6 cand=1 promo=6 |
...
| feature:feature_candidate_source_family_count:two_to_three | 42 | 4 | 4 | 9.5% | 6.7% |
...
| feature:feature_candidate_source_family_signature:forward_index+reverse_lookup+semantic_bridge | 7 | 3 | 3 | 42.9% | 40.0% |
...
| feature:feature_shadow_candidate_count:four_plus | 75 | 3 | 3 | 4.0% | 1.2% |
