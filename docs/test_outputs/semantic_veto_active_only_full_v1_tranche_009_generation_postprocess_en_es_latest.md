...
- Generated: `2026-05-13T19:29:51Z`
- Active generated items audited: `76`
- Families: `38`
...
| Target lemma in evidence note | 4 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `all_sentence_plus_note` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | control: current scoring appends generated sentence plus evidence_note |
| `sentence_plus_scrubbed_note` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | mechanically remove target lemmas and meta labels from evidence_note |
| `sentence_only_all` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | use generated browser sentences only, dropping explanatory notes |
| `note_only_diagnostic` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | diagnostic: evidence_note only, to see whether notes are driving lift |
| `no_high_eval_overlap_sentence_plus_note` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | drop generated rows with high lexical overlap against frozen eval cases |
| `no_high_eval_overlap_sentence_only` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | drop high eval-overlap rows and use sentence-only evidence |
| `pos_anchored_sentence_only` | 0 | n/a | n/a | 0 | 0 | 0 | 0 | keep rows whose generated source usage mechanically matches expected POS |
| `no_definition_like_sentence_only` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | drop definition-like generated browser sentences and use sentence-only evidence |
...
| `quality_top1_sentence_only` | 38 | n/a | n/a | 0 | 0 | 0 | 0 | keep one highest-quality sentence-only row per family |
| `quality_top2_sentence_only` | 76 | n/a | n/a | 0 | 0 | 0 | 0 | keep up to two highest-quality sentence-only rows per family after audit scoring |
