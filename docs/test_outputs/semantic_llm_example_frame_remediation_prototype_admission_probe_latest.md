...
- Status: `ok`
- Generated: `2026-04-24T22:49:19Z`
- Scope: `prompt_queue`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `Prototype reverse_aux_plus_llm_example_frame_missing_rows_plus_remediation, family phrase guard` | `family_all` | `runtime_phrase_guard_only` | 40 | 5 | 7 | 56.2% | 70.0% | 1 | 0 |
| `Prototype reverse_aux_plus_llm_example_frame_missing_rows_plus_remediation, active phrase guard` | `active_only` | `runtime_phrase_guard_only` | 40 | 2 | 7 | 56.2% | 77.5% | 12 | 0 |
| `Prototype reverse_aux_plus_llm_example_frame_missing_rows_plus_remediation, phrase-control containment guard` | `active_only` | `local_containment_patterns` | 40 | 2 | 7 | 56.2% | 77.5% | 12 | 2 |
| `Prototype reverse_aux_plus_llm_example_frame_missing_rows_plus_remediation, surface-POS rescue guard` | `active_only` | `local_containment_patterns_plus_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% | 12 | 2 |
| `Prototype reverse_aux_plus_llm_example_frame_missing_rows_plus_remediation, phrase-control prototype guard` | `active_only` | `semantic_prototype_competition` | 40 | 2 | 9 | 43.8% | 72.5% | 12 | 0 |
