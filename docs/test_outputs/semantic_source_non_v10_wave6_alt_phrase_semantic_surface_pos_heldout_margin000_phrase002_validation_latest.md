...
| --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| `promotion_candidate_composite` | `sentence_transformer_cosine` | `masked_sentence` | 0.0 | 0.02 | `active_shadow_phrase_semantic_surface_pos` | 38 | 0 | 2 | 87.5% | 94.7% |

## Empty Baseline Comparator

| Source | Scorer | Context | Margin | Phrase Margin | Shape | Cases | Harmful | False Abstain | Recall | Accuracy |
| --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| `empty_batch` | `sentence_transformer_cosine` | `masked_sentence` | 0.0 | 0.02 | `active_shadow_phrase_semantic_surface_pos` | 38 | 0 | 16 | 0.0% | 57.9% |
