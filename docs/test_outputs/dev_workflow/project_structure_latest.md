...
| --- | ---: | ---: | ---: | ---: |
| `docs_test_outputs` | 2395 | 2324 | 71 | 711828354 |
| `core_tests` | 321 | 309 | 12 | 2723233 |
| `scripts_testing` | 316 | 315 | 1 | 5339066 |
...
| `docs_developer` | 92 | 91 | 1 | 1282344 |
| `docs_rulegen` | 50 | 49 | 1 | 1300277 |
...
| --- | ---: | ---: | ---: |
| `docs/test_outputs` | 2395 | 2324 | 71 |
| `core/tests` | 321 | 309 | 12 |
...
| `docs/test_outputs/rulegen_benchmark_en_es_kaikki_bidir_latest.md` | 1 | 711 |
| `docs/test_outputs/rulegen_benchmark_en_es_kaikki_bidir_reverse_latest.html` | 1 | 58692 |
...
| `experiment_payload` | 683 | 122762384 | 0 | 411 | review by experiment: high-volume evidence, not deletion by size alone | `docs/test_outputs/experiments/rulegen_en_es_broad_sweep_20260328/rulegen_en_es_canonical_replay_20260328.json`<br>`docs/test_outputs/experiments/rulegen_en_es_broad_sweep_20260328/rulegen_en_es_canonical_replay_20260328_timing.json`<br>`docs/test_outputs/experiments/rulegen_en_es_broad_sweep_20260328/rulegen_en_es_dataset_expansion_and_refocused_frontier_20260328.md`<br>`docs/test_outputs/experiments/rulegen_en_es_broad_sweep_20260328/rulegen_en_es_helper_run_rulegen_smoke_20260328.json` |
...
| `root_dated_snapshot` | 2 | 6157 | 0 | 2 | review after canonical summary exists | `docs/test_outputs/semantic_veto_llm_pilot_generated_rows_en_es_repair_20260505_001.json`<br>`docs/test_outputs/semantic_veto_llm_pilot_generated_rows_en_es_repair_20260505_003.json` |
...
| --- | ---: | --- |
| `srs_publication_manifest_en-es.json` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json` |
| `srs_rulegen_snapshot_en-es.json` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json` |
| `srs_ruleset_en-es.json` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json` |
| `srs_semantic_inventory_en-es.json` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json` |
| `stopwords-de.json` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json` |
| `manifest.json` | 4 | `apps/chrome-extension/manifest.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-full-v1-tranche-011/manifest.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/manifest.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/manifest.json` |
...
| `semantic_inventory.json` | 3 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-full-v1-tranche-011/semantic_inventory.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/semantic_inventory.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/semantic_inventory.json` |
...
| `srs_publication_manifest_en-es` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json` |
| `srs_rulegen_snapshot_en-es` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json` |
| `srs_ruleset_en-es` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json` |
| `srs_semantic_inventory_en-es` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json` |
| `stopwords-de` | 6 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json` |
...
| `manifest` | 4 | `apps/chrome-extension/manifest.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-full-v1-tranche-011/manifest.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/manifest.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/manifest.json` |
...
| `semantic_inventory` | 3 | `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-full-v1-tranche-011/semantic_inventory.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/semantic_inventory.json`<br>`docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/semantic_inventory.json` |
...
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-full-v1-tranche-011/manifest.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-full-v1-tranche-011/semantic_inventory.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_publication_manifest_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_ruleset_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-full-v1-tranche-011-product-install-data-root/srs/stopwords/stopwords-de.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/manifest.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/semantic_inventory.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_publication_manifest_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_rulegen_snapshot_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_ruleset_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/profiles/semantic-alpha/srs_semantic_inventory_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-native-host-install-data-root/srs/stopwords/stopwords-de.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/manifest.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/language_packs/en-es/semantic_packs/en-es-active-only-combined-product-scope-v1/semantic_inventory.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_publication_manifest_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_rulegen_snapshot_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_ruleset_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/profiles/semantic-alpha/srs_semantic_inventory_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-combined-product-scope-v1-product-install-data-root/srs/stopwords/stopwords-de.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-active-only-poc-v5-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_publication_manifest_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_rulegen_snapshot_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_ruleset_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/profiles/default/srs_semantic_inventory_en-es.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_source_packaging/en-es-product-scope-band-grading-v1-active-only-helper-runtime-smoke-data-root/srs/stopwords/stopwords-de.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/licensing_header_audit/latest.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/resource_integrity_audit/latest.json` | `docs_test_outputs` | generated_evidence_output, duplicate_filename, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-002-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-003-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-004-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-005-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-006-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-007-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-008-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
| `docs/test_outputs/experiments/semantic_veto_evidence_gap_batches/en-es-semantic-veto-evidence-gap-generation-en-es-active-only-full-v1-tranche-009-approved_raw_responses.json` | `docs_test_outputs` | generated_evidence_output, duplicate_stem |
