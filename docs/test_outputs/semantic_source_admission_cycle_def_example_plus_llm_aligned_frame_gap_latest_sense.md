...
- Batch: `en-es:example-frame-composite:def-example-plus-llm-aligned-source-frame-gap-v1-20260429a`
- Admitted batch: `en-es:example-frame-composite:def-example-plus-llm-aligned-source-frame-gap-v1-20260429a:sense-admitted`

## Summary

- Input rows: `124`
- Semantic rows: `124`
- Semantic admitted rows: `123`
