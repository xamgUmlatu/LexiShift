...
- Status: `ok`
- Generated: `2026-04-30T18:29:15Z`
...
| P1 | queued | Continue the integrity audit before more wave7 research: verify current-looking latest artifacts, dirty generated outputs, and methodology docs are classified as runtime truth, current candidate evidence, generated evidence, historical context, superseded, or queued follow-up. | data_artifacts | `semantic_veto_reconciliation_workstream`, `semantic_veto_system_registry`, `semantic_veto_archive_consolidation_ledger`, `decision_research_lanes_ledger`, `source_admission_program_doc`, `decision_rule_comparison_plan`, `semantic_sentence_veto_algorithm_doc`, `wave7_phrase_control_triage_admission`, `wave7_phrase_control_rescue_sweep`, `wave7_phrase_control_no_surface_margin_sweep` | The registry currently has 27 latest-path entries classified as generated_evidence, historical_reference, or superseded; uncommitted latest outputs remain non-authoritative until an audit pass either classifies, regenerates, commits, or explicitly leaves them out of scope. | Regenerate the registry summary, run focused registry tests, run doc-reference checks, validate registry JSON, and run git diff whitespace checks; avoid new semantic evidence generation unless the user explicitly switches to the research lane. |
...
| wave7_active_shadow_validation | generated_evidence | source_admission | docs/test_outputs/semantic_source_non_v10_wave7_source_class_breadth_v1_heldout_validation_latest.md | Records 1 harmful replacement and 5 false abstains across 32 active/shadow cases. |
...
| wave7_phrase_control_triage_active_shadow_validation | generated_evidence | source_admission | docs/test_outputs/semantic_source_non_v10_wave7_source_class_breadth_v1_phrase_control_triage_heldout_validation_latest.md | Records the persistent 1 harmful replacement and 5 false abstains across 32 active/shadow cases. |
| wave7_phrase_control_triage_admission | generated_evidence | source_admission | docs/test_outputs/semantic_source_admission_cycle_wave7_source_class_breadth_v1_phrase_control_triage_latest.md | Restores 16/16 semantic and 16/16 phrase contract coverage with 307 final admitted rows; status remains review due leakage and heldout blockers. |
...
| wave7_phrase_validation | generated_evidence | source_admission | docs/test_outputs/semantic_source_non_v10_wave7_source_class_breadth_v1_phrase_validation_latest.md | Records 6 harmful replacements across 16 phrase/no-winner cases. |
| wave7_rescue_policy_validation | generated_evidence | source_admission | docs/test_outputs/semantic_surface_pos_rescue_policy_validation_wave7_source_class_breadth_v1_latest.md | Records 7 harmful replacements and 5 false abstains across 48 cases. |
| wave7_source_admission_report | generated_evidence | source_admission | docs/test_outputs/semantic_source_admission_cycle_wave7_source_class_breadth_v1_latest.md | Executed wave7 admission evidence; status is review. |
