...
- benchmark_json: `docs/test_outputs/rulegen_benchmark_en_de_source_freq_experiment_latest.json`
- pairs_processed: 1
- failing_or_review_count: 20

| Pair | Case | Target | Status | Reasons | Top1 | Top3 |
|---|---|---|---|---|---|---|
| en-de | `en-de:Haus` | Haus | REVIEW | top1_not_in_expected_set | establishment | establishment, home, institution |
| en-de | `en-de:Schule` | Schule | REVIEW | top1_not_in_expected_set | pod | pod, tutor, school |
| en-de | `en-de:Weg` | Weg | REVIEW | top1_not_in_expected_set | alley | alley, path, way |
...
| en-de | `en-de:Fenster` | Fenster | FAIL | forbidden_candidate_present | box | box, windowed, window |
| en-de | `en-de:Tag` | Tag | FAIL | forbidden_candidate_present | tag | tag, doomsday, day |
...
| en-de | `en-de:Straße` | Straße | FAIL | forbidden_candidate_present | avenue | avenue, strait, road |
| en-de | `en-de:Idee` | Idee | FAIL | forbidden_candidate_present | notion | notion, inspiration, idea |
| en-de | `en-de:Preis` | Preis | FAIL | forbidden_candidate_present, expected_candidate_missing_from_top3 | award | award, cost, prize |
| en-de | `en-de:Chef` | Chef | REVIEW | top1_not_in_expected_set | chief | chief, boss |
| en-de | `en-de:Zug` | Zug | FAIL | forbidden_candidate_present | strain | strain, train, stroke |
...
| en-de | `en-de:Grund` | Grund | FAIL | top1_is_forbidden | motive | motive, reason, warrant |
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: establishment, home, institution"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: pod, tutor, school"
  ],
  "candidate_forbidden_top1": [
    "pod"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: alley, path, way"
  ],
  "candidate_forbidden_top1": [
    "alley"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: box, windowed, window"
  ],
  "candidate_forbidden_top1": [
    "box"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: tag, doomsday, day"
  ],
  "candidate_forbidden_top1": [
    "tag"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: avenue, strait, road"
  ],
  "candidate_forbidden_top1": [
    "avenue"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: award, cost, prize"
  ],
  "candidate_forbidden_top1": [
    "award"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: strain, train, stroke"
  ],
  "candidate_forbidden_top1": [
    "strain"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: motive, reason, warrant"
  ],
  "candidate_forbidden_top1": [
    "motive"
  ],
