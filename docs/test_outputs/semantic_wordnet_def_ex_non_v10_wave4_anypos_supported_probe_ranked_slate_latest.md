...
- Status: `ok`
- Generated: `2026-04-28T01:29:10Z`
- Batch: `en-es:wordnet-example-frames:wordnet-def-ex-non-v10-wave4-anypos-supported-probe-ranked-slate-v1-20260428a`
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `en-es:sentence-veto:change:cambio` | `target` | 2 | 2 | 0 | 4 | `cambio:07311046-n@0.0`<br>`cambiar:00109468-v@0.4` |
...
| `en-es:sentence-veto:use:uso` | `target` | 2 | 2 | 0 | 4 | `uso:00948944-n@0.4`<br>`usar:01161188-v@0.4` |
...
| `en-es:sentence-veto:train:tren` | `target` | 2 | 2 | 0 | 4 | `tren:04475240-n@0.2857`<br>`adiestrar:00604693-v@0.2` |
| `en-es:sentence-veto:land:tierra` | `target` | 2 | 4 | 0 | 6 | `tierra:09357302-n@0.2222`<br>`país:08562388-n@0.25`<br>`atracar:01985450-v@0.2222` |
| `en-es:sentence-veto:mean:medio` | `target` | 2 | 2 | 0 | 4 | `medio:01598728-s@0.2`<br>`significar:00957180-v@0.2` |
| `en-es:sentence-veto:end:fin` | `target` | 2 | 2 | 0 | 4 | `fin:08583557-n@0.0`<br>`acabar:02615799-v@0.3333` |
| `en-es:sentence-veto:offer:oferta` | `target` | 2 | 2 | 0 | 4 | `oferta:07179197-n@0.25`<br>`ofrecer:02303593-v@0.25` |
| `en-es:sentence-veto:rest:reposo` | `target` | 2 | 4 | 0 | 6 | `reposo:13833030-n@0.0`<br>`descanso:13833030-n@0.0`<br>`descansar:01548665-v@0.0` |
| `en-es:sentence-veto:present:presente` | `target` | 2 | 2 | 0 | 4 | `presente:01735600-a@0.1667`<br>`actual:15144478-n@0.2` |
| `en-es:sentence-veto:sign:se-al` | `target` | 2 | 4 | 0 | 6 | `señal:06659006-n@0.0`<br>`seña:07290723-n@0.4`<br>`firmar:00998530-v@0.2222` |
