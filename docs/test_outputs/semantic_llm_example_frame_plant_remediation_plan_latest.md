...
- Status: `ready`
- Generated: `2026-04-24T23:10:08Z`
...
| --- | --- | --- | --- | --- | ---: | ---: |
| `en-es:example-frame-remediation:active:en-es-sentence-veto-plant-planta` | `remediation_active_example` | `en-es:sentence-veto:plant:planta` | `planta` | `false_abstain_active_example_gap` | 2 | 445 |
