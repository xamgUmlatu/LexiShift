...
- Rows: `183`
- Families: `16`
- Relations: `{"anchor_cue": 84, "shadow_candidate": 99}`
...
| 2 | `en-es:wave7-source-class-breadth-v1:evidence-composite:filtered` | `wordnet_translation_sense_source_class_non_v10_wave7_source_class_breadth_v1` | 183 | 183 | 0 |
