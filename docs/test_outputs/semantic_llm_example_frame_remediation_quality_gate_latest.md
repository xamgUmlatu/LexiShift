...
- Generated: `2026-04-24T22:49:34Z`
- Run batch: `en-es:example-frame-missing-rows:example-frame-remediation-v1-20260425a`
- Contract batch: `en-es:example-frame-composite:reverse-aux-plus-llm-missing-rows-plus-remediation-latest`
...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| `prototype_reviewed_examples_family_guard` | `runtime_phrase_guard_only` | `fail` | 70.0% | 56.2% | 5 | 7 |
