...
- Status: `ok`
- Generated: `2026-04-28T22:41:51Z`
- Ledger: `/Users/takeyayuki/Documents/projects/LexiShift/docs/test_inputs/semantic_decision_research_lanes_en_es.json`
- Lane count: `14`
...
| non_v10_breadth_validation | active_source_program | heldout_breadth | analysis_only | Automatic non-v10 source-supported waves are promising but still need broader held-out proof and phrase-contract coverage before runtime-quality claims. The wave64 any-POS supported sweep found a 16-family semantic source portfolio, and the materialized portfolio passes the source-admission cycle with 51 final admitted rows, 0 leakage rejects, 0 sense rejects, and semantic contract coverage 16 / 16. The first independent held-out suites block promotion: active/shadow is 2 harmful / 3 false abstains across 32 cases, and phrase/no-winner is 3 harmful across 16 cases. A no-write margin sensitivity check showed this is not a simple threshold issue. | Classify and fix reusable blocker classes before breadth expansion: source-evidence gaps for active false abstains, surface/POS or sense-family errors for active/shadow harmful replacements, and phrase/no-winner containment for fast/present/end-style failures. Do not tune directly on these held-out cases or claim promotion from this portfolio yet. |
