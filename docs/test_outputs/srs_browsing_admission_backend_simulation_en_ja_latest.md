...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `料理` | `料理` | 0.6017 | 4.5 | 4.5 | 0.0 | 0.9 | 1.0 | source_mapping |
| `病院` | `病院` | 0.5681 | 4.0 | 0.0 | 4.0 | 0.0 | 1.0 | target_surface |
| `野菜` | `野菜` | 0.5681 | 4.0 | 4.0 | 0.0 | 0.8 | 1.0 | source_mapping |
| `診断` | `診断` | 0.4893 | 3.0 | 3.0 | 0.0 | 0.75 | 1.0 | source_mapping |
| `治療` | `治療` | 0.3878 | 2.0 | 0.0 | 2.0 | 0.0 | 1.0 | target_surface |
| `金利` | `金利` | 0.309 | 1.4 | 1.4 | 0.0 | 0.7 | 1.0 | source_mapping |
| `会社` | `会社` | 0.2447 | 1.0 | 0.0 | 1.0 | 0.0 | 1.0 | target_surface |
| `切捨て確認` | `切捨て確認` | 0.2447 | 1.0 | 0.0 | 1.0 | 0.0 | 1.0 | target_surface |
