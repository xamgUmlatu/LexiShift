...
- Status: `ok`
- Generated: `2026-04-25T00:05:22Z`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `Prototype reverse_aux_llm_balanced_plus_source_coverage, family phrase guard` | `family_all` | `runtime_phrase_guard_only` | 95 | 7 | 8 | 78.9% | 84.2% | 7 | 0 |
| `Prototype reverse_aux_llm_balanced_plus_source_coverage, active phrase guard` | `active_only` | `runtime_phrase_guard_only` | 95 | 2 | 8 | 78.9% | 89.5% | 21 | 0 |
| `Prototype reverse_aux_llm_balanced_plus_source_coverage, phrase-control containment guard` | `active_only` | `local_containment_patterns` | 95 | 2 | 8 | 78.9% | 89.5% | 21 | 2 |
| `Prototype reverse_aux_llm_balanced_plus_source_coverage, surface-POS rescue guard` | `active_only` | `local_containment_patterns_plus_surface_pos` | 95 | 0 | 2 | 94.7% | 97.9% | 21 | 2 |
| `Prototype reverse_aux_llm_balanced_plus_source_coverage, phrase-control prototype guard` | `active_only` | `semantic_prototype_competition` | 95 | 2 | 10 | 73.7% | 87.4% | 21 | 0 |
