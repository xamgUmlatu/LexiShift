...
| --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
| `generated_composite` | `all_dataset_families` | `tfidf_cosine` | `masked_sentence` | 0.0 | 0.05 | `active_shadow_containment_surface_pos` | 95 | 0 | 24 | 36.8% | 74.7% |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
...
- best_viable_without_surface_pos_row: `generated_active_only` / `prompt_queue` / `tfidf_cosine` / `masked_window` / `active_shadow_active_pos_guard` -> 1 harmful, 12 false abstain, 25.0% recall
