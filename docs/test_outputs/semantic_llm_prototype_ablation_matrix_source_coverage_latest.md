...
- Status: `ok`
- Generated: `2026-04-25T00:03:31Z`
...
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
...
| --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
| `generated_composite` | `all_dataset_families` | `token_jaccard` | `masked_sentence` | 0.0 | 0.05 | `active_shadow_containment_surface_pos` | 95 | 0 | 10 | 73.7% | 89.5% |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
...
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
| `generated_no_phrase` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
...
| --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_sentence` | 0.35 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `masked_window` | 0.0 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `raw_sentence` | 0.0 | 0.05 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
| `generated_composite` | `prompt_queue` | `tfidf_cosine` | `raw_window` | 0.0 | 0.0 | `active_shadow_containment_surface_pos` | 40 | 0 | 2 | 87.5% | 95.0% |
...
- best_candidate_source_row: `generated_composite` / `prompt_queue` / `tfidf_cosine` / `masked_sentence` / `active_shadow_containment_surface_pos` -> 0 harmful, 2 false abstain, 87.5% recall
...
- best_viable_without_surface_pos_row: `generated_active_only` / `all_dataset_families` / `tfidf_cosine` / `raw_sentence` / `active_shadow_active_pos_guard` -> 0 harmful, 36 false abstain, 5.3% recall
...
- best_generated_composite_row: `generated_composite` / `prompt_queue` / `tfidf_cosine` / `masked_sentence` / `active_shadow_containment_surface_pos` -> 0 harmful, 2 false abstain, 87.5% recall
...
- best_generated_no_phrase_row: `generated_no_phrase` / `prompt_queue` / `tfidf_cosine` / `masked_sentence` / `active_shadow_containment_surface_pos` -> 0 harmful, 2 false abstain, 87.5% recall
