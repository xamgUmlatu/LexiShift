...
- Batch: `en-es:manual-example-frame-replacements:source-coverage-leakage-safe-v1-20260425a`
- Filtered batch: `en-es:manual-example-frame-replacements:source-coverage-leakage-safe-v1-20260425a:filtered`
