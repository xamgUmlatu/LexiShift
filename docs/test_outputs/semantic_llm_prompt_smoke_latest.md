...
| --- | --- | ---: | ---: | --- |
| `cue_contrastive_general_v1` | `active` | 2 | 2 | Keep the first general cue slot small and contrastive.<br>Use same-POS or ordinary competition families only. |
| `cue_cross_pos_frame_v1` | `active` | 4 | 4 | This is the primary first-tranche slot on v10.<br>Favor frame-sensitive noun-active vs verb-shadow cue generation. |
