...
- benchmark_json: `docs\test_outputs\experiments\rulegen_en_es_stage_a_admission_frontier_v2_100cases_20260329.json`
- pairs_processed: 1
...
| en-es | `en-es:móvil` | móvil | REVIEW | top1_not_in_expected_set | mobile | mobile, mobile phone |
| en-es | `en-es:registro` | registro | REVIEW | top1_not_in_expected_set | registration | registration, record |
| en-es | `en-es:patrón` | patrón | REVIEW | top1_not_in_expected_set | patron | patron, boss |
| en-es | `en-es:mando` | mando | REVIEW | top1_not_in_expected_set | command | command, gamepad |
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: mobile, mobile phone"
  ],
  "candidate_forbidden_top1": [
    "mobile"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: registration, record"
  ],
  "candidate_forbidden_top1": [
    "registration"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: patron, boss"
  ],
  "candidate_forbidden_top1": [
    "patron"
  ],
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: command, gamepad"
  ],
  "candidate_forbidden_top1": [
    "command"
  ],
