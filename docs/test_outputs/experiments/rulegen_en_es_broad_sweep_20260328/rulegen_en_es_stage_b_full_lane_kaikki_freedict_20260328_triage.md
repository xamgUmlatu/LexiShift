...
- benchmark_json: `docs\test_outputs\experiments\rulegen_en_es_broad_sweep_20260328\rulegen_en_es_stage_b_full_lane_kaikki_freedict_20260328.json`
- pairs_processed: 1
...
| en-es | `en-es:cuadro` | cuadro | FAIL | expected_candidate_missing_from_top3 | square | square, squad |
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: square, squad"
  ],
  "candidate_forbidden_top1": [
    "square"
  ],
