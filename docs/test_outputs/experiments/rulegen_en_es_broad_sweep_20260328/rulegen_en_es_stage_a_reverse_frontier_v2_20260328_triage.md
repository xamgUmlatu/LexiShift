...
- benchmark_json: `docs\test_outputs\experiments\rulegen_en_es_broad_sweep_20260328\rulegen_en_es_stage_a_reverse_frontier_v2_20260328.json`
- pairs_processed: 1
...
| en-es | `en-es:cuenta` | cuenta | REVIEW | top1_not_in_expected_set | count | count, tab, account |
...
```json
{
  ...
  "notes": [
    ...
    "Observed top3 sources: count, tab, account"
  ],
  "candidate_forbidden_top1": [
    "count"
  ],
