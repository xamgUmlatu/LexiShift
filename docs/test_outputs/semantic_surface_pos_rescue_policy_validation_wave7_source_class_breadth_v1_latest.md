...
- Generated: `2026-04-30T18:07:29Z`
...
- Harmful cases: `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:gross:002, en-es:source-non-v10-wave7-source-class-breadth-phrase:v1:cast:001, en-es:source-non-v10-wave7-source-class-breadth-phrase:v1:wrong:001, en-es:source-non-v10-wave7-source-class-breadth-phrase:v1:stretch:001, en-es:source-non-v10-wave7-source-class-breadth-phrase:v1:score:001, en-es:source-non-v10-wave7-source-class-breadth-phrase:v1:squeeze:001, en-es:source-non-v10-wave7-source-class-breadth-phrase:v1:foul:001`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `active_shadow` | `false` | 32 | 1 | 5 | 68.8% | 81.2% | 4 | `review` / `heldout_review` |
| `phrase_no_winner` | `false` | 16 | 6 | 0 | 0.0% | 62.5% | 4 | `review` / `heldout_review` |

## Rescue Applications

| Suite | Case | Gold | Before | After | Active | Shadow | Phrase | Phrase Lead | Surface Signal | Trace |
| --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| `active_shadow` | `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:like:001` | `replace` | `abstain` | `abstain` | 0.5745 | 0.5902 | 0.0 | -0.5902 | `` | none |
...
| `active_shadow` | `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:fix:001` | `replace` | `abstain` | `abstain` | 0.626 | 0.6948 | 0.0 | -0.6948 | `shadow_verb_frame` | none |
| `active_shadow` | `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:full:001` | `replace` | `abstain` | `abstain` | 0.5516 | 0.6309 | 0.0 | -0.6309 | `active_modifier_frame` | active_modifier_margin_below_floor |
| `active_shadow` | `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:even:001` | `replace` | `abstain` | `abstain` | 0.7168 | 0.5392 | 0.0 | -0.7168 | `` | none |
| `active_shadow` | `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:meet:001` | `replace` | `abstain` | `abstain` | 0.557 | 0.6926 | 0.0 | -0.6926 | `` | none |
| `active_shadow` | `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:stretch:001` | `replace` | `replace` | `replace` | 0.6781 | 0.7109 | 0.0 | -0.7109 | `active_noun_frame` | rescue |
| `active_shadow` | `en-es:source-non-v10-wave7-source-class-breadth-heldout:v1:score:001` | `replace` | `replace` | `replace` | 0.7115 | 0.7148 | 0.0 | -0.7148 | `active_noun_frame` | rescue |
