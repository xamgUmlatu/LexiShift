...
2. [FAIL] `QUALITY_FLOOR_BREACH`: Quality floor failed for pair 'en-es'.
   - top1_accuracy=0.8333 below min_top1_accuracy=0.9500
   - forbidden_top1_rate=0.1667 above max_forbidden_top1_rate=0.0500
   - forbidden_any_rate=0.1250 above max_forbidden_any_rate=0.1000
...
6. [FAIL] `DELTA_BUDGET_BREACH`: Delta budgets failed for pair 'en-es'.
   - top1_accuracy drop=0.1667 exceeds budget=0.0000
   - top3_recall drop=0.0417 exceeds budget=0.0000
   - forbidden_top1_rate increase=0.1667 exceeds budget=0.0000
   - forbidden_any_rate increase=0.1250 exceeds budget=0.0000
   - avg_rules_per_target increase=0.6667 exceeds budget=0.5000
