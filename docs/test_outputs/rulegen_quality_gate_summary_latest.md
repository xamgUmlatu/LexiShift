...
2. [FAIL] `QUALITY_FLOOR_BREACH`: Quality floor failed for pair 'en-es'.
   ...
   - top3_recall=0.9474 below min_top3_recall=0.9500
   - forbidden_top1_rate=0.2105 above max_forbidden_top1_rate=0.0500
   - forbidden_any_rate=0.2105 above max_forbidden_any_rate=0.1000
...
6. [FAIL] `DELTA_BUDGET_BREACH`: Delta budgets failed for pair 'en-es'.
   ...
   - top3_recall drop=0.0526 exceeds budget=0.0000
   - forbidden_top1_rate increase=0.2105 exceeds budget=0.0000
   - forbidden_any_rate increase=0.2105 exceeds budget=0.0000
   - avg_rules_per_target increase=1.1053 exceeds budget=0.5000
