...
- PASS `EXPLICIT_INTEREST_LIFTS_TOPIC_MATCHES`: Explicit `animals` interest promoted animal-related candidates. (gain=5.0)
...
- PASS `IMPLICIT_TOPIC_BIAS_LIFTS_MATCHES`: Derived implicit topic weights promoted media-related candidates. (gain=3.0)
...
- top_lemmas: dog, elephant, fur, money, home
- average_focus_rank: 2.0
- dog [delta=+5, score=0.48]: Boosted by topic_affinity, while remaining supported by coverage_gain.
- elephant [delta=+5, score=0.458]: Boosted by topic_affinity, while remaining supported by coverage_gain.
- fur [delta=+5, score=0.4415]: Boosted by topic_affinity, while remaining supported by coverage_gain.
...
- top_lemmas: livestream, funny, money, home, case
- average_focus_rank: 1.5
- livestream [delta=+4, score=0.4665]: Boosted by topic_affinity, while remaining supported by coverage_gain.
- funny [delta=+2, score=0.4605]: Boosted by topic_affinity, while remaining supported by coverage_gain.
