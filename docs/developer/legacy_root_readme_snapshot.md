...
- `docs/architecture/README.md`: architecture docs status map (implemented vs WIP).
...
- `docs/architecture/design_diagram_workplan.md`: six high-priority diagram plan + maintenance rules.
