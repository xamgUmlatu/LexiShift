...
Last verified: 2026-04-08 pair-local benchmark dataset split validation + en-ja preset audit
...
- Pair-local benchmark datasets (development edit surface): `docs/test_inputs/rulegen_benchmark_cases/<pair>.json`
- Compatibility aggregate benchmark dataset: `docs/test_inputs/rulegen_benchmark_cases.json`
- Dataset split/merge helper: `scripts/testing/rulegen_benchmark_case_sync.py`
...
- Update the touched pair-local dataset under `docs/test_inputs/rulegen_benchmark_cases/`.
- Refresh `docs/test_inputs/rulegen_benchmark_cases.json` with `python scripts/testing/rulegen_benchmark_case_sync.py merge`.
