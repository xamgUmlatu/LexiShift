...
- `docs/developer/productization_lane6_data_provenance_inventory.md` now
  records L6-A through L6-Qa: current pack/source provenance inventory, pack
  ...
  app-managed build/parser lineage and raw artifact checksum capture.
...
- The main finding is explicit: managed pack roots and publication manifests
  ...
  converter-version, license-approval, or non-installer checksum lineage.
- The next Lane 6 slices should add source-version, converter-version,
