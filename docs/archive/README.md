...
Archive files preserve historical reasoning and evidence snapshots. They should
not be used as current implementation, release, or product-policy authority
unless a current doc explicitly points to the surviving lesson.
