...
- Chrome extension: `apps/chrome-extension/shared/helper/helper_client.js`, `apps/chrome-extension/shared/helper/helper_transport_extension.js`, `apps/chrome-extension/options.js`
