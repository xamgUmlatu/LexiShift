...
6. Header controls are redundant and unclear.
...
7. Language pack management is overloaded in a single settings tab.
   - Four large, action-dense tables in one scroll path increase cognitive load.
   - Key code paths:
     - `apps/gui/src/dialogs.py:345`
     - `apps/gui/src/settings_language_packs.py:186`
     - `apps/gui/src/settings_language_packs.py:215`
     - `apps/gui/src/settings_language_packs.py:595`
     - `apps/gui/src/settings_language_packs.py:668`
8. Status colors are hardcoded and not theme-aware.
   - Hardcoded colors produce contrast issues (especially in dark themes).
   - Key code paths:
     - `apps/gui/src/settings_language_packs.py:397`
     - `apps/gui/src/settings_language_packs.py:825`
     - `apps/gui/src/main.py:244`
     - `apps/gui/src/preview.py:73`
