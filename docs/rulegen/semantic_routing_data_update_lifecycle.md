...
Last verified: 2026-05-14 helper CLI/native-host semantic-pack installer tests, named-pack resolver tests, default tranche-009 dev pack, and disposable product-root install smoke
...
3. the current repo dev-pack path for named development packs, including the
   current default `en-es-active-only-combined-full-v1-tranche-009`
