...
The immediate engineering gap is now tranche-011 operator checkpoint if desired.
Do not run another active-only paid generation tranche unless the SRS-derived
