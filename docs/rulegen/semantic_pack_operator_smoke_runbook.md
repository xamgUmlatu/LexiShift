...
Last verified: 2026-05-14 against the `en-es-active-only-combined-full-v1-tranche-010` default pack id, Advanced debug install flow wiring, helper/native-host install command, split-inline DOM semantic-context runtime fix, optimized semantic batching, tranche-010 automated install/page-scan evidence, tranche-005 operator checkpoint evidence, and tranche-003 hands-on operator smoke evidence
...
The tranche-010 pack is automated-clean and ready for operator smoke. It has
...
8. Leave `Semantic pack id` as `en-es-active-only-combined-full-v1-tranche-010`.
...
Known useful pages from the tranche-010 automated scan and earlier tranche-003
smoke:
