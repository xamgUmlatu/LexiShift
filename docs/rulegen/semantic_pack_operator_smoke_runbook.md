...
8. Leave `Semantic pack id` as `en-es-active-only-combined-full-v1-tranche-011`.
...
Known useful pages from the tranche-011 automated scan and earlier tranche-003
smoke:
